...
export function AwardNavbar() {
    return (
        <div className="bg-[#ACC8EA] px-10 py-5">
            <div className="flex flex-col gap-3">
                <h1 className="text-3xl font-bold">Use your leafs to earn awards</h1>
                <h2 className="text-2xl text-black font-medium">Choose some of the options below to better your experience in social sooth</h2>
